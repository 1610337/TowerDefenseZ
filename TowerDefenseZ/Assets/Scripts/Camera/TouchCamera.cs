	...
	void Update() {
		if (Input.touchCount == 0) {
			...
			if (oldTouchPositions[0] == null || oldTouchPositions[1] != null) {
				...
				transform.position += transform.TransformDirection((Vector3)((oldTouchPositions[0] - newTouchPosition) * m_OrthographicCamera.orthographicSize / m_OrthographicCamera.pixelHeight * 6f));
				//TODO : !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                // call another method to check whether the vector3 is whitin a certain range otherwise transform the position the the max range
                // figure out the ranges by experimenting a little with the camera and checking it´s values
